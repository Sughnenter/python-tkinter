...
def drawcirce():
    clearcanv()
    canv.create_oval(250, 250, 120, 120, outline="black", fill=str(colorchooser.askcolor()[1]))
...
def createimage():
    clearcanv()
    image = PhotoImage(file="Screenshot_2019-08-31-13-13-39-1.png")
...
button8 = Button(frame1b,text="image",font=("Helvertica bold",14),fg="white",bg=front,command=createimage)


scrollbar = Scrollbar(frame2)
canv = Canvas(frame2, bg= "#ecbcac", yscrollcommand=scrollbar.set,height=450,width=500,bd=3,scrollregion=(0,0,1000,1000))
frame1.propagate(0)
frame1b.propagate(0)
frame2.propagate(0)
